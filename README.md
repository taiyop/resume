...
【プロジェクト概要】人事労務DXクラウドの設計及び実装を担当。大手顧客向けの機能開発。CSからPdMとのやりとりまで関わり、仕様書作成から実装まで一気通貫して担当。PdM,CS, QAチームとも連携した上での開発。
【推進した業務】
- 曖昧な要件の洗い出しと対応案の推進
- DB設計およびソフトウェアアーキテクチャ設計
- Figmaを使った既存サービスのデザインシステム構築と全チーム共有展開。
- 処理フローの抽象化及び構造化
- クリーンアーキテクチャを使った、SOLID原則に基づいた設計及び実装

【結果】
- 配属チームが担当するプロジェクトの炎上対応
- Railsへのクリーンアーキテクチャの導入
- 当初の計画通りのサービスインの実現

### AIキャラクターサービスの開発及び運用　【Python/Fast API/AWS/LLM/TypeScript/React】##################(2023年8月 ~ 2024年8月)
...
- Xトレンド及びYahoo News Top、またテレビメディアへの大きな露出による会社知名度PRの向上を実現
- 当初の計画通りのサービスインの実現

### エンタメメディアの開発及び運用　【Ruby/Rails/GCP/CloudFlare】　(2020年8月 ~ 2026年1月)
